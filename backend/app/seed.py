...
CAPABILITIES = [
    ...
    {
        "code": "CAP-136",
        "name": "LOLBins and Proxy Execution Control",
        "domain": "endpoint",
        "description": "Detects and constrains signed binary proxy execution and living-off-the-land abuse on endpoints.",
    },
    {
        "code": "CAP-137",
        "name": "Artifact Hiding and Cleanup Detection",
        "domain": "endpoint",
        "description": "Identifies hidden artifacts, indicator removal, and attacker cleanup activity on managed systems.",
        "requires_data_sources": True,
        "supported_by_analytics": True,
    },
    {
        "code": "CAP-138",
        "name": "Event-Triggered Execution Protection",
        "domain": "endpoint",
        "description": "Covers event-triggered execution paths such as shell extensions, subscriptions, and handler abuse.",
    },
    {
        "code": "CAP-139",
        "name": "Boot and Logon Autostart Control",
        "domain": "endpoint",
        "description": "Monitors and constrains persistence through boot, logon, and startup extensibility mechanisms.",
    },
    {
        "code": "CAP-140",
        "name": "Process Injection Detection",
        "domain": "endpoint",
        "description": "Detects memory injection, process hollowing, and related in-memory execution tradecraft.",
        "requires_data_sources": True,
        "supported_by_analytics": True,
    },
    {
        "code": "CAP-141",
        "name": "Execution Flow Hijack Detection",
        "domain": "endpoint",
        "description": "Detects DLL search-order abuse, path interception, and other execution flow hijacking techniques.",
        "requires_data_sources": True,
        "supported_by_analytics": True,
    },
    {
        ...
        "domain": "endpoint",
        "description": "Detects renamed binaries, misleading metadata, and adversary attempts to blend malicious artifacts into normal files.",
        "requires_data_sources": True,
        "supported_by_analytics": True,
    },
    {
        "code": "CAP-143",
        "name": "Defense Impairment Protection",
        "domain": "endpoint",
        "description": "Detects or blocks attempts to disable logging, sensors, and other security controls.",
    },
    {
        "code": "CAP-144",
        "name": "Endpoint Collection and Capture Monitoring",
        "domain": "endpoint",
        "description": "Monitors local collection, input capture, screen capture, and other endpoint-centric collection behaviors.",
        "requires_data_sources": True,
        "supported_by_analytics": True,
    },
    {
        "code": "CAP-145",
        "name": "Staging and Automated Exfiltration Monitoring",
        "domain": "data",
        "description": "Detects data staging, archive preparation, and automated exfiltration behaviors before data leaves the environment.",
        "requires_data_sources": True,
        "supported_by_analytics": True,
        "supported_by_response": True,
    },
    {
        "code": "CAP-146",
        "name": "Destructive Impact and Recovery Protection",
        "domain": "data",
        "description": "Detects or blocks destructive impact activity such as data destruction, disk wipe, and recovery inhibition.",
        "supported_by_response": True,
    },
    {
        "code": "CAP-147",
        "name": "Password Store and Secret Access Protection",
        "domain": "identity",
        "description": "Protects password stores, unsecured credentials, and sensitive authentication material from attacker access.",
    },
    {
        "code": "CAP-148",
        "name": "Authentication Process Tampering Detection",
        "domain": "identity",
        "description": "Detects adversary manipulation of authentication providers, MFA integrations, and login processing paths.",
        "requires_data_sources": True,
        "supported_by_analytics": True,
    },
    {
        "code": "CAP-149",
        "name": "Token, Cookie, and Session Abuse Detection",
        "domain": "identity",
        "description": "Detects theft and misuse of tokens, cookies, and active authentication sessions.",
        "requires_data_sources": True,
        "supported_by_analytics": True,
        "supported_by_response": True,
    },
    {
        "code": "CAP-150",
        "name": "Certificate and Key Abuse Detection",
        "domain": "identity",
        "description": "Detects misuse of certificates, keys, and other strong authentication material.",
        "requires_data_sources": True,
        "supported_by_analytics": True,
    },
    {
        "code": "CAP-151",
        "name": "Protocol Tunneling and Encrypted C2 Detection",
        "domain": "network",
        "description": "Detects encrypted channels, protocol tunneling, and covert command-and-control transport patterns.",
        "requires_data_sources": True,
        "supported_by_analytics": True,
    },
    {
        "code": "CAP-152",
        "name": "Remote Admin Tool and RAT Detection",
        "domain": "network",
        "description": "Detects suspicious remote administration tools and attacker-operated remote control channels.",
        "requires_data_sources": True,
        "supported_by_analytics": True,
        "supported_by_response": True,
    },
    {
        "code": "CAP-153",
        "name": "Network Sniffing and Discovery Detection",
        "domain": "network",
        "description": "Detects network sniffing, discovery, and topology-enumeration behaviors across managed environments.",
        "requires_data_sources": True,
        "supported_by_analytics": True,
    },
    {
        "code": "CAP-154",
        "name": "Cloud Control Plane Abuse Detection",
        "domain": "cloud",
        "description": "Detects abuse of cloud administrative APIs, identity roles, and workload control planes.",
        "requires_data_sources": True,
        "supported_by_analytics": True,
        "supported_by_response": True,
    },
    {
        "code": "CAP-155",
        "name": "SaaS and Cloud Repository Abuse Detection",
        "domain": "cloud",
        "description": "Detects suspicious access to SaaS repositories, cloud storage, and shared information stores.",
        "requires_data_sources": True,
        "supported_by_analytics": True,
    },
    {
        "code": "CAP-156",
        "name": "Container and Serverless Execution Detection",
        "domain": "cloud",
        "description": "Detects suspicious execution in containers, orchestrators, and serverless runtimes.",
        "requires_data_sources": True,
        "supported_by_analytics": True,
    },
    {
        "code": "CAP-157",
        "name": "Public-Facing Application Component Abuse Detection",
        "domain": "application",
        "description": "Detects web shell placement, server component abuse, and malicious API-driven application actions.",
        "requires_data_sources": True,
        "supported_by_analytics": True,
    },
    {
        "code": "CAP-158",
        "name": "Reconnaissance and Victim Discovery Monitoring",
        "domain": "exposure",
        "description": "Tracks active scanning and adversary discovery of external victim infrastructure, identities, and exposed services.",
        "requires_data_sources": True,
        "supported_by_analytics": True,
    },
    {
        "code": "CAP-159",
        "name": "Infrastructure Acquisition and Staging Monitoring",
        "domain": "exposure",
        "description": "Tracks attacker resource development such as domains, servers, accounts, and staged capabilities used before intrusion.",
        "requires_data_sources": True,
        "supported_by_analytics": True,
    },
]
...
CAPABILITY_FAMILIES_BY_CODE = {
    "CAP-001": "Endpoint Execution & Scripting",
    "CAP-002": "Endpoint Execution & Scripting",
    "CAP-003": "Credential & Secret Protection",
    "CAP-004": "Email Security",
    "CAP-005": "Command & Control",
    "CAP-006": "Command & Control",
    "CAP-007": "Data Exfiltration & Governance",
    "CAP-008": "Identity Threat Detection",
    "CAP-009": "Identity Threat Detection",
    "CAP-010": "Privileged Access & Session Control",
    "CAP-011": "Authentication Artifact Abuse",
    "CAP-012": "Remote Services & Lateral Movement",
    "CAP-013": "Endpoint Impact Protection",
    "CAP-014": "Privileged Access & Session Control",
    "CAP-015": "Privileged Access & Session Control",
    "CAP-016": "Endpoint Execution & Scripting",
    "CAP-017": "Data Exfiltration & Governance",
    "CAP-018": "Data Exfiltration & Governance",
    "CAP-019": "Command & Control",
    "CAP-020": "Security Analytics",
    "CAP-021": "Identity Administration & Change Control",
    "CAP-022": "Identity Administration & Change Control",
    "CAP-023": "Credential Hygiene & Identity Posture",
    "CAP-024": "Credential Hygiene & Identity Posture",
    "CAP-025": "Application Exposure Protection",
    "CAP-026": "Response Orchestration",
    "CAP-027": "Response Orchestration",
    "CAP-028": "Response Orchestration",
    "CAP-029": "Authentication Artifact Abuse",
    "CAP-030": "Remote Services & Lateral Movement",
    "CAP-031": "Application Exposure Protection",
    "CAP-032": "Network Segmentation & Access",
    "CAP-101": "Network Segmentation & Access",
    "CAP-102": "Network Segmentation & Access",
    "CAP-103": "Device Compliance & Hardening",
    "CAP-104": "Data Exfiltration & Governance",
    "CAP-105": "Data Exfiltration & Governance",
    "CAP-106": "Data Exfiltration & Governance",
    "CAP-107": "Data Exfiltration & Governance",
    "CAP-108": "Data Exfiltration & Governance",
    "CAP-109": "Data Exfiltration & Governance",
    "CAP-110": "Application Exposure Protection",
    "CAP-111": "Device Compliance & Hardening",
    "CAP-112": "Device Compliance & Hardening",
    "CAP-113": "Device Compliance & Hardening",
    "CAP-114": "Identity Administration & Change Control",
    "CAP-115": "Directory Security Assessment",
    "CAP-116": "Directory Security Assessment",
    "CAP-117": "Credential Hygiene & Identity Posture",
    "CAP-118": "Pre-Attack Recon & Resource Development",
    "CAP-119": "Credential Hygiene & Identity Posture",
    "CAP-120": "Credential Hygiene & Identity Posture",
    "CAP-121": "Credential Hygiene & Identity Posture",
    "CAP-122": "Identity Administration & Change Control",
    "CAP-123": "Identity Administration & Change Control",
    "CAP-124": "Privileged Access & Session Control",
    "CAP-125": "Credential & Secret Protection",
    "CAP-126": "Privileged Access & Session Control",
    "CAP-127": "Privileged Access & Session Control",
    "CAP-128": "Identity Threat Detection",
    "CAP-129": "Identity Threat Detection",
    "CAP-130": "Network Exposure Assessment",
    "CAP-131": "Network Exposure Assessment",
    "CAP-132": "Identity Administration & Change Control",
    "CAP-133": "Identity Threat Detection",
    "CAP-134": "Security Analytics",
    "CAP-135": "Security Analytics",
    "CAP-136": "Endpoint Evasion & Defense Impairment",
    "CAP-137": "Endpoint Evasion & Defense Impairment",
    "CAP-138": "Endpoint Persistence & Autoruns",
    "CAP-139": "Endpoint Persistence & Autoruns",
    "CAP-140": "Process Injection & Execution Hijack",
    "CAP-141": "Process Injection & Execution Hijack",
    "CAP-142": "Endpoint Evasion & Defense Impairment",
    "CAP-143": "Endpoint Evasion & Defense Impairment",
    "CAP-144": "Endpoint Collection & Capture",
    "CAP-145": "Data Exfiltration & Governance",
    "CAP-146": "Endpoint Impact Protection",
    "CAP-147": "Credential & Secret Protection",
    "CAP-148": "Authentication Artifact Abuse",
    "CAP-149": "Authentication Artifact Abuse",
    "CAP-150": "Authentication Artifact Abuse",
    "CAP-151": "Network Tunneling & Remote Access",
    "CAP-152": "Network Tunneling & Remote Access",
    "CAP-153": "Network Tunneling & Remote Access",
    "CAP-154": "Cloud & SaaS Control Plane",
    "CAP-155": "Cloud & SaaS Control Plane",
    "CAP-156": "Cloud & SaaS Control Plane",
...
CAPABILITY_DEFAULT_ROLES_BY_FAMILY = {
    "Application & API Component Abuse": ["detect", "prevent"],
    "Application Exposure Protection": ["detect", "prevent"],
    "Authentication Artifact Abuse": ["detect", "prevent"],
    "Cloud & SaaS Control Plane": ["audit", "detect", "prevent"],
    "Command & Control": ["alert", "detect"],
    "Credential & Secret Protection": ["detect", "prevent"],
    "Credential Hygiene & Identity Posture": ["assess", "detect", "prevent"],
    "Data Exfiltration & Governance": ["detect", "govern", "prevent"],
    "Device Compliance & Hardening": ["govern", "harden", "prevent"],
    "Directory Security Assessment": ["assess", "audit"],
    "Email Security": ["detect", "prevent"],
    "Endpoint Collection & Capture": ["alert", "detect"],
    "Endpoint Evasion & Defense Impairment": ["detect", "prevent"],
    "Endpoint Execution & Scripting": ["detect", "prevent"],
    "Endpoint Impact Protection": ["detect", "prevent", "respond"],
    "Endpoint Persistence & Autoruns": ["detect", "prevent"],
    "Identity Administration & Change Control": ["audit", "automate", "govern"],
    "Identity Threat Detection": ["alert", "detect"],
    "Network Exposure Assessment": ["assess", "detect"],
    "Network Segmentation & Access": ["govern", "prevent"],
    "Network Tunneling & Remote Access": ["detect", "prevent"],
    "Pre-Attack Recon & Resource Development": ["assess", "detect"],
    "Privileged Access & Session Control": ["govern", "prevent"],
    "Process Injection & Execution Hijack": ["detect", "prevent"],
    "Remote Services & Lateral Movement": ["detect", "prevent"],
    "Response Orchestration": ["automate", "respond"],
    "Security Analytics": ["alert", "detect"],
}

missing_capability_families = sorted(
    capability["code"] for capability in CAPABILITIES if capability["code"] not in CAPABILITY_FAMILIES_BY_CODE
)
if missing_capability_families:
    raise ValueError(
        "Missing capability family assignments for: " + ", ".join(missing_capability_families)
    )

for capability in CAPABILITIES:
    capability["family"] = CAPABILITY_FAMILIES_BY_CODE[capability["code"]]
...
def _seed_capability_coverage_roles(db: Session) -> None:
    ...
    for capability in capabilities_by_name.values():
        role_codes = list(
            dict.fromkeys(
                [
                    *CAPABILITY_DEFAULT_ROLES_BY_FAMILY.get(capability.family, []),
                    *CAPABILITY_COVERAGE_ROLE_ASSIGNMENTS.get(capability.name, []),
                ]
            )
        )
        if not role_codes:
